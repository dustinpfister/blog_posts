...
* () json: vertcolor-trees - position and color for four.json of '6tri'
* () json: vertcolor-trees - five and six json files for '6tri'

* () videoground-blog-posts: video1 for threejs-tube-geometry based on curve path update demo
* () forpost: threejs-buffer-geometry-loader - update promise loader demo to what was worked out in three-buffer-geometry
