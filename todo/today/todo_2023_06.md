...
* () start post #1052 on linux-aplay
* () figure out how to move forward with some kind of project where I generate audo sample data to pipe into aplay

* () forpost: threejs-buffer-geometry-attributes-position - start new morph attributes section
* () forpost: threejs-extrude-geometry - write more about uvgen demos
