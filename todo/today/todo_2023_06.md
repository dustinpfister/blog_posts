...
* () demos-linux : linux-aplay - new section on writing json files for argumnets for funcitons that generate sample data
* () edit: demos-linux : write about new JSON file dmeo section

* () build and publish

* () demos r152 : examples-aplay-sin-frames -
* () demos r152 : examples-aplay-live - start a new demo based on the live script that I made for aplay
