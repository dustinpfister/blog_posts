...
* () forpost: start forpost folder on lathe-geometry with at least one basic example
* () new:  start post #1048 on threejs-lathe-geometry, write about first basic example
