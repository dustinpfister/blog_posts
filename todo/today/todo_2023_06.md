...
* () forpost: threejs-texture - have a data texture demo
* () forpost: threejs-texture - have a texture loader demo
* () forpost: expand todo list for future work
* () edit: threejs-texture - write about examples thus far
