...
* () forpost : threejs-examples-aplay-frame-scripts - start for post folder for this project
* () forpost : threejs-examples-aplay-frame-scripts - vertarray script that works by passing a number of points that are used
