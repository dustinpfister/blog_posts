...
### () - FRI 06/30/2023
* (done) edit: threejs-object3d-traverse - proof read
* () edit: threejs-userdata - proof read
* () build and publish
* () json: work on 0.json of set1 for tri12-bufferfly json folder project 

### () - THU 06/29/2023
* (done) start post #1056 on linux-sudo
* (done) edit: threejs-object3d-get-world-position - poof read
* (done) forpost:  threejs-object3d-get-world-position - new loop demo
* (done) edit: threejs-object3d-get-world-position - write about new loop demo

### () - WED 06/28/2023
* (done) edit: threejs-object3d-type - proof read
* (done) forpost: threejs-type - new types section started
* (done) edit: threejs-object3d-type - write about new demo
* (done) forpost: threejs-materials - new demo
* (done) edit: threejs-materials - write about new demo
* (done) json: work on tri12 project more

### () - TUE 06/27/2023
* (done) edit: threejs-object3d-scale - proof read
* (done) forpost: start threejs-texture for post folder
* (done) start post #1055 on threejs-texture
* (done) forpost: threejs-texture - have a texture loader demo
* (done) forpost: expand todo list for future work
* (done) edit: threejs-texture - write about examples thus far
* (done) forpost: threejs-object3d-position - new demos for raycatser and ox3
* (done) edit: threejs-object3d-position - new demos
* (done) edit: threejs-object3d-parent - proof read
* (done) videoground-blog-posts - video1 for threejs-texture

### () - MON 06/26/2023
* (done) edit: threejs-light - proof read
* (done) edit: threejs-depth-material - proof read
* (done) forpost: threejs-depth-material - canvas demo of  custom section
* (done) edit: threejs-depth-material - write about new demo
* (done) edit: threejs-object3d - proof read
...
### () - SAT 06/24/2023
* (done) edit: threejs-lambert-material - proof read

### () - FRI 06/23/2023
* (done) edit: threejs-directional-light - proof read
* (done) edit: threejs-buffer-geometry-attributes-normals - proof read

### () - THU 06/22/2023
* (done) start post #1054 on threejs-buffer-attribute
* (done) edit: threejs-camera-move - proof read
* (done) edit: threejs-buffer-geometry-attributes-color - check for post folder
* (done) edit: threejs-sphere - proof read
* (done) build and publish

### () - WED 06/21/2023
* (done) edit: threejs-shader-material - proof read
* (done) start post #1053 on linux-du
* (done) edit: linux-du - expand post to at least 500 words
* (done) edit: threejs-buffer-geometry-attributes-color - proof read
* (done) start a threejs-buffer-attribute for post folder for tomorrows new blog post on the subject

### () - TUE 06/20/2023
* (done) edit : threejs-materials - proof read
* (done) edit : threejs-phong-material - proof read

### () - MON 06/19/2023
* (done) edit: threejs-buffer-geometry-rotation - proof read
* (done) edit : threejs-spotlights - proof read
* (done) demos-linux : linux-aplay - new section on writing json files for arguments for functions that generate sample data
* (done) edit: demos-linux : write about new JSON file dmeo section
* (done) demos r152 : examples-aplay-frame-scripts - start new demo on using aplay
