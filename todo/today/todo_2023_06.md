...
### () - TUE 06/27/2023
* () edit: threejs-depth-material - proof read

### () - MON 06/26/2023
* (done) edit: threejs-light - proof read
* () forpost: threejs-light - expand and improve some demos outline in todo list
* () edit: threejs-light - write about new demos
