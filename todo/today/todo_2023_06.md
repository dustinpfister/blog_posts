...
* () forpost: threejs-buffer-geomerty-attributes-uv - minimap debugger
...
### () - SAT 06/10/2023
* () forpost: threejs-vector2 - expand sections
* () edit: threejs-vector2 - write about new demos
* () build and publish

* () json: vertcolor-trees - have more than one morph attribute
* () demo: update vercolor-trees-tri6-morph to make use of more than one morph attribute

* () json: vertcolor-bugs - start a new json folder of butter flys
* () json: vertcolor-solidworlds - start a collection of simple worlds as single, solid shapes
