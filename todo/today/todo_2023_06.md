...
* () forpost: threejs-extrude-geometry - 


### () - WED 06/14/2023
* (done) edit: threejs-extrude-geometry - expand on custom UV Section opening

* () edit: threejs-line - link to new post on Tube Geometry, proof read begining of post

* () forpost: threejs-extrude-geometry - edit and expand uvgen section
* () forpost: threejs-extrude-geometry - expand basic section by at least one demo
* () edit: threejs-extrude-geometry - expand and edit UV and Basic Sections
