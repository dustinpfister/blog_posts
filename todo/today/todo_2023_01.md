...
* () forpost: threejs-buffer-geometry-compute-vertex-normals - new basic example
* () forpost: start new threejs-buffergeometry-morph-attributes base on current r146 demos
<!-- Edit -->
* () edit: threejs-buffer-geometry-compute-vertex-normals - write about new basic example
<!-- Beta World Videos -->
