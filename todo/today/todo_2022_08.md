...
## () - SUN 08/28/2022 to  WED 08/31/2022
...
### () - TUE 08/30/2022
* (done) work on r3 of object-grid-wrap-land example

* () edit threejs-object-grid-wrap-land
* () videoground-blog-posts: threejs-object-grid-wrap-land video2

* () start weird-blob-guy-one r140 prototype
* () start weird-face-two r140 prototype

* () start r4 of dae tools based on what I have for late tween-many and object-grid-wrap-land projects
* () r3 of object-grid-wrap-land example
...
### () - SUN 08/28/2022
* (done) r3 of object-grid-wrap-land - simple addAt method with function for custom logic
* (done) work on land-set-one dae folder - 'c file' with origins at the bottom of trees 
...
### () - SAT 08/27/2022
* (done) work on land-set-one dae folder in test threejs along with r3 of land object wrap example

### () - FRI 08/26/2022
* (done) for post folder for threejs-examples-many-object-tweening based on r140 proto-many-object-tweening
* (done) start post #1002 on threejs-examples-many-object-tweening
* (done) video1 for threejs-examples-many-object-tweening
* (done) buld and publish

### () - THU 08/25/2022
* (done) updated desc for youtube videos from threejs-examples-biplane
* (done) updated desc for youtube videos from threejs-mesh-copy
* (done) updated desc for youtube videos from threejs-examples-nested-groups
* (done) updated desc for youtube videos from threejs-examples-tree
* (done) start proto-many-object-tweening
...
* (done) start a new animation example for the post that will also be used in the video
* (done) videoground-blog-posts: threejs-vector3-normalize
* (done) edit threejs-vector3-normalize
