...
This week I will like to get a current list of best preforming posts for threejs, say a top ten or so, and start focusing just on those posts in terms of editing text, creating more examples, and also addtional videos. I might have a single exception or two this week but for the most part that is what I would like to start doing.
...
### () - FRI 09/10/2022
* (done) start post #1007 on threejs-
...
* () start a prototype for fridays new post
* () get a list togetaher for top ten posts and start editing fist post
