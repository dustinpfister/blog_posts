...
I can only do so much per day, when I find something that needs doing I can park it here first.
...
* () test-threejs: start proto for SVG loader

* () start DAE file for fireflowermendo.com logo?
