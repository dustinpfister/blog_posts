...
### () - FRI 03/31/2023
* (done) forpost: new threejs-quaternion-premultiply for post folder
* (done) forpost: threejs-quaternion-premultiply - start for post folder
* (done) start post # 1034 threejs-quaternion-premultiply

### () - THU 03/30/2023
* (done) edit: threejs-data-texture - proof read opening and intro
* (done) edit: threejs-buffer-geometry-compute-bounding-box - proof read opening and intro
* (done) edit: threejs-buffer-geometry-compute-bounding-box - new loop demo
* (done) forpost: threejs-getting-started - finish up s3-1-stocastic-basic
* (done) edit: threejs-getting-started - write about new s3-1-stocastic-basic example

### () - WED 03/29/2023
* (done) edit: threejs-vector3-lerp - edit opening and intro
* (done) edit: threejs-vector3-lerp - update demos to r146 style
* (done) forpost: threejs-vector3-lerp - new curve section
* (done) edit: threejs-vector3-lerp - write about new demos
* (done) forpost: threejs-quaternion - start userspace section
* (done) forpost: threejs-getting-started - new start point for stochastic animation loops
