...
<!-- EDIT -->
* () linux-lsb-release - expand more on this subject
<!-- THREEJS-MATERIALS -->
* () forpost: threejs-materials - expand shader section more
* () edit: threejs-materials - write about new shader demo\(s\)
<!-- videoground r9 -->
* () videoground-r9 : work on updating the write frame method for writing data in general
...
<!-- videoground r9 -->
* () videoground-r9 : work more on current start video
* () videoground-r9 : update readme file
<!-- tri12 -->
