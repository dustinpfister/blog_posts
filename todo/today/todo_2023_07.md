...
* () edit: threejs-buffer-geometry-attributes-normals - fix any factual errors about vertex order
* () edit: threejs-buffer-geometry-compute-vertex-normals - fix any factual errors about vertex order
* () build and publish
<!-- tri12 -->
