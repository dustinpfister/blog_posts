...
<!-- videoground -->
* () videoground-blog-posts: make a video for the new demo made for threejs-camera-perspective
* () videoground-blog-posts: upload and embed the new video for threejs-camera-perspective
<!-- publish -->
* () build and publish
<!-- 'tri12' project -->
* () examples-tri12-scene - get opacity effect to work with the grid
* () examples-tri12-scene - removed code that is not needed from grid module
* () examples-tri12-scene - update code style of grid module to r152 style
