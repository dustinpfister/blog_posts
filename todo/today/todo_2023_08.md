...
<!-- new -->
* () new: start post # 1068 on threejs-sprite
<!-- edit 5k+ -->
* () forpost: threejs-buffer-geometry - expand methods section with two new demos
* () edit: threejs-buffer-geometry - write about new demos
...
<!-- new -->
* () start a threejs-sprite for post folder
<!-- publish -->
* () build and publish
* () update comment policy in disqus settings
<!-- videoground-beta-world -->
* (done) audio-generator-1 : work more on timeline
<!-- electionjs -->
