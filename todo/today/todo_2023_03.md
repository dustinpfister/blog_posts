...
This week I would like to work on logo design, as well as any tools that prove to be relavant to doing so. I will be starting out by making my own logo, but in time I think I will also want to be able to do this sort of thing for clients as well of course.
...
### () - SUN 03/12/2023
<!-- NEW POST PROTOTYPES -->
* () r146 prototype: examples-svg-tools - start a protoype that is a collection of tools for loading and using svg files
