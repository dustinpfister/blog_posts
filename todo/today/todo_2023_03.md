...
* () forpost: threejs-quaternion - new demo on the methods used to rotate the sphere
* () forpost: threejs-quaternion - new section on geting axis and angle
* () edit: threejs-quaternion - expand with new sections
