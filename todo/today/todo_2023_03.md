...
* () forpost: threejs-vector3-normalize - new basic example
* () edit: threejs-vector3-normalize - proof read / expand basic section

* () forpost: threejs-vector3-normalize - update other sections to r146 style
* () edit: threejs-vector3-normalize - proof read other sections and conclusion

* () videoground-blog-posts: video2 for threejs-vector3-normalize based on sphere demo
