...
### () - MON 10/09/2022
* () prototype: work on one or more protos for Fridays post
* () edit: threejs-canvas-texture - 

### () - SUN 10/09/2022
* () edit: threejs-canvas-texture - check current state of for post folder
* () prototype: start proto for Fridays post
