...
* () start post #1010 on threejs-examples-
...
<!-- r2 of threejs-examples-sequence-hooks -->
* (done) work on r2 of threejs-examples-sequence-hooks - from numbers feature of v3Array
* () edit : threejs-examples-sequence-hooks - start new section on r2 
* () edit : threejs-examples-sequence-hooks - section on first demo of r2
* () edit : threejs-examples-sequence-hooks - section on numbers array

<!-- The prototype for friday -->
* () I would like to start a new prototype that has to do with creating these arrays of Vector3 objects to use with r2 of seghooks
* () I want to be able to use expressions as a starting point
