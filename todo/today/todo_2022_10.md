...
### () - TUE 10/10/2022
* () edit: threejs-examples-sphere-mutate - write about new r1 example
* () videoground-blog-posts: threejs-examples-sphere-mutate video1 on r1 of the example

* () edit: threejs-shape - update code for basic, hole, and group sections
* () edit: threejs-canvas-texture - at least start a module example

* () forpost: start for post folder for fridays post based on current protos
* () prototype: work on protos
