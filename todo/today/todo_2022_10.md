...
* () I would like a new revision of seq hooks that will make use of one or more arrays of Vector3 objects to update mesh objects
* () I would like to start a new prototype that has to do with creating these arrays of Vector3 objects
