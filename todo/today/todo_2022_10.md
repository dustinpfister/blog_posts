...
### () - THU 10/20/2022
<!-- PLANE GEO POST CAN BE EXPANDED A LOT WITH EVERYTHING I KNOW NOW -->
* () forpost: threejs-plane - new attributes section starting with position
* () edit: threejs-plane - write about new attributes section
