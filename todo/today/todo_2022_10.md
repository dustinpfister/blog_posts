...
* () edit threejs-buffer-geometry-attributes-position : non indexed version of box geometry example

* () edit: threejs-lookat - proof read section 2 on world space
* () edit: threejs-data-texture - write more about new examples
...
* () threejs-examples-animation-loop-module : work on r1 of the module
