...
* () edit: threejs-examples-text-plane - to reflect r0 and current demos
...
* () edit: threejs-plane - embed video2

<!-- for post folder for fridays post -->
* () forpost: start prototype for Fridays post

<!-- canvas texture post -->
* () forpost: threejs-canvas-texture - continue work on new module section
* () edit: threejs-canvas-texture - write about new canvasjs module
