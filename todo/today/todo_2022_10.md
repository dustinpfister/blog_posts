...
* () forpost folder for threejs-examples-canvas-text-plane starting with what I worked out for threejs-canvas-texture
* () start post #1009 on threejs-examples-canvas-text-plane
