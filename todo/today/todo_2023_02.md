...
* () forpost: threejs-examples-scene-shake - rename folders
* () forpost: threejs-examples-scene-shake - update to r146 style

* () edit: threejs-examples-scene-shake - proof read opening and getting started
* () edit: threejs-examples-scene-shake - expand getting started
* () edit: threejs-examples-scene-shake - r1 section should come first, then r0 section
* () edit: threejs-examples-scene-shake - proof read r1 section
* () edit: threejs-examples-scene-shake - proof read r2 section
* () edit: threejs-examples - proof read section on threejs-examples-scene-shake

* () forpost: threejs-curves-cubicbeziercurve3
