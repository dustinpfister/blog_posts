...
### () - THU 02/02/2023
* () edit: threejs-examples-lines-deterministic - proof read
* () forpost: threejs-examples-lines-deterministic - update source code
* () videoground-blog-posts: threejs-examples-lines-deterministic - finish video1
* () edit: threejs-examples-lines-deterministic - update source code sections
