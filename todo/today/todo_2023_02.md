...
* () forpost: threejs-curves-cubicbeziercurve3 - start a loop section, and have code that will be used to make video1 for the post
* () videoground-blog-posts: video1 for threejs-curves-cubicbeziercurve3
* () build and publish
