...
* () check out threejs-grouping-mesh-objects for post folder

<!-- EDIT -->
* () eddit threejs-grouping-mesh-objects : proof read opening
* () eddit threejs-grouping-mesh-objects : proof read getting started
