...
### () - SAT 11/05/2022
* () edit: threejs-examples-uvmap-cube-canvas-update - expand more on the module itself
* () edit: threejs-examples-uvmap-cube-canvas-update - expand more on the r0 demos
...
* () start video for threejs-examples-uvmap-cube-canvas-update
* () embed video into threejs-examples-uvmap-cube-canvas-update if done
