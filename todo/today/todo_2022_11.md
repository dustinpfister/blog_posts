...
* () forpost: threejs-object3d-position - new determ loop example base on video 1 source
* () forpost: threejs-object3d-position - start a new detrem loop example for video2
