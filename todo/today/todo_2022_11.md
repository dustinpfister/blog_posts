...
### () - WED 11/30/2022
* (done) forpost: threejs-face3-color - get examples working
* (done) edit: threejs-face3-color - link to forpost, write about updated code examples
* (done) video1 for threejs-object3d-visible
* (done) edit: threejs-object3d-visible - embed video1 when dome
* (done) edit: threejs-object3d-visible - write about video1 example
* (done) for post: threejs-object3d-scale - scale geo example
* (done) edit: threejs-object3d-scale - write about new scale geo example
* (done) edit: threejs-clock - proof read opening, and getting started.
<!-- videoground-blog-posts -->
<!-- edit/new -->
* () forpost: threejs-clock - have a for post folder and link to it from the post
* () edit: threejs-clock - proof read rest of post
...
* (done) edit: threejs-object3d-visible - proof read #1
* (done) edit: threejs-object3d-visible - proof read #2
* (done) edit: threejs-object3d-visible - proof read #3
* (done) edit: threejs-object3d-visible - proof read concusion
* (done) forpost: threejs-object3d-visible - expand basic section
* (done) forpost: threejs-object3d-visible - start first video project for this
