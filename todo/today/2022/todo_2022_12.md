...
### () - THU 12/29/2022
* (done) start post #1020 on threejs-phong-material
* (done) forpost: threejs-phong-material - finish first set of demos for blog post

* () forpost: threejs-canvas-texture - new demo where I set magFilter and minFilter values
* () edit: write abotu new filters demo
...
* (done) forpost: threejs-examples-basic-framework - r1 of example, and basic demo
* (done) edit: threejs-examples-basic-framework - update with new code examples, proof read
* (done) forpost: start a threejs-phong-material folder
