...
BLOG, LODASH, JAVASCRIPT, MVP-LITTLE-CITY

For the first month of January I wrote my usual plan for new year blog cat post, but beyond that the focus was mainly on lodash and javaScript content.

At the end of this month I also started my MVP-LITTLE-CITY project where the aim is to just create and maintain what a Minimal Viable Product is for a little city simulator game.
...
### (done) - MON 01/31/2022
* (done) new post #956 on js-javascript-example-tool-source-layer-2d
* (done) build and publish
* (done) r1 of js-javascript-example-mvp-little-city

### (done) - SUN 01/30/2022
* (done) todo-edit-lodash one item
* (done) r0 of js-javascript-example-mvp-little-city
