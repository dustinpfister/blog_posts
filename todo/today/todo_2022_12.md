...
<!-- forpost -->
* () forpost: threejs-examples-werid-walk-one : update for post folder to main js plus demos pattern
* () forpost: threejs-examples-werid-walk-two : update for post folder to main js plus demos pattern
* () forpost: threejs-examples-werid-walk-three : update for post folder to main js plus demos pattern
