...
<!-- edit -->
* () threejs-curve - link to threejs-curve-geometry-from
* () threejs-curve-quadratic-bezier-curve3 - link to threejs-curve-geometry-from

<!-- for post -->
* forpost: threejs-curve-geometry-from - addtional basic exmaple that uses the get point method
