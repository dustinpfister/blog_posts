...
### () - WED 12/04/2022
<!-- new/edit -->
* () forpost: threejs-buffer-geometry-index - more demos ( at least 3 )
...
* () forpost: start a loop section for the post and what I want for video1
* () start a threejs-line-fat-width folder
<!-- new/edit -->
* () forpost: start a threejs-buffer-geometry-index for post folder
