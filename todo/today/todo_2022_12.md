...
### () - WED 12/14/2022
<!-- for post -->
* () forpost: threejs-buffer-geometry-index - update examples to use an array over buffer attribute
* () forpost: start at least one r146 demo for friday
<!-- edit-->
* () edit: threejs-buffer-geometry-index - update source code
* () edit: threejs-buffer-geometry-index - like to wave example
