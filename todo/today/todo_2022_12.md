...
<!-- new/edit -->
* () edit: threejs-buffer-geometry-index - write sections for all current demos
* () edit: threejs-buffer-geometry-index - write getting started
* () edit: threejs-buffer-geometry-index - write conclusion

* () edit: threejs-standard-material - write about new basic examples
* () edit: threejs-box3 -
<!-- for post -->
