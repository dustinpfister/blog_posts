---
title: 34 Canvas examples and counting, animations, games, modules, and more.
...
### 2.12 - [Flappy collector idle](/2020/01/21/canvas-example-game-flappy-collector-idle/)
...
### 2.13 - [Flappy collector idle a flappy bird clone](/2020/01/16/canvas-example-game-flappy-collector/)

This is just a flappy bid clone of sorts.

### 2.14 - [A kaboom clone](/2020/04/10/canvas-example-game-kaboom-clone/)
...
### 2.15 - [Map idle game prototype example](/2020/01/13/canvas-example-game-map-idle/)
...
### 2.19 - [Grid gradient](/2020/03/26/canvas-example-grid-gradient/)
...
### 2.20 - [Grid world simulator core](/2020/04/15/canvas-example-grid-worldsim-core/)

A start with what might become a world simulator type canvas example thing like that of Sim Earth.

### 2.21 - [Canvas Grid module](/2019/11/07/canvas-example-grid/)

A grid module for canvas projects.

### 2.22 - [The limits of 2d images](/2019/12/11/canvas-example-image-limits/)
...
### 2.27 - [search and destroy particles](/2020/04/13/canvas-example-particles-search-destroy-and-spawn/)

Search and destroy particles.

### 2.28 - [Pointer manager](/2020/01/29/canvas-example-pointer-manager-mouse-and-touch/)
...
### 2.29 - [Pointer movement](/2020/01/26/canvas-example-pointer-movement/)
...
### 2.30 - [pop the lock game clone](/2019/11/26/canvas-example-pop-the-lock/)
...
### 2.34 - [Turret defense](/2020/01/10/canvas-example-turret-defense)
