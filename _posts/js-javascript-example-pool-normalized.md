...
This is not the first time I made this sort of library that I then end up using in one or more additional projects, in fact this is still very much based off of what I started in my [canvas examples series post on this subject of object pools](/2020/07/20/canvas-example-object-pool/).
