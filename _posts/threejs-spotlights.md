...
## 2 - Getting shadows to work with a spotlight
...
## 3 - Static spotlight helper example
...
### 4.2 - Spotlight geometry and other metrics
...
### 4.3 - Spotlight helper animation loop example
