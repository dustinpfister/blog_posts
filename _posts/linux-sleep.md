...
Once I work out what the text of the bash script is I can save it as something like sleep-basic-loop.sh. Then if I want to I can start the script with the bash command, or I can use the [chmod command](/2020/11/13/linux-chmod/) to make the file executable, then run it directly.
