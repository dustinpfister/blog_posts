...
## 6 - Pushing, shifting, and adding elements to an array

### 6.1 - Just adding, or overwriting by index

### 6.1 - Use Array.push to add an element to the end of an Array

### 6.2 - Use Array.shift to add an element to and end of an Array

### 6.3 - Array.concat, and Array.splice
