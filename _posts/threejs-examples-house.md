...
This time it will be yet another one of my models that is [just a group](/2018/05/16/threejs-grouping-mesh-objects/) collection of [mesh objects](/2018/05/04/threejs-mesh/) using the built in threejs geometry constructors rather than an external file of one type or another such as the [Collada file standard](/2021/04/30/threejs-dae-collada-loader/). However there will be one little part in which I am making a custom geometry as well.
