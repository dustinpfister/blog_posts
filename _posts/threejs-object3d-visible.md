...
## 4 - First video project for this post

Here I have the source code that the first video for this post is based on. I just wanted to have a bunch of objects that make a group and have them in a ring like order. Then I just switch the visible boolean values back and for for every other mesh object in each group of mesh objects.
