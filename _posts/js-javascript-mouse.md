...
For this example I am attaching an event hander to a div element, and using the inner html property as a way to create, and recreate a child div each time the parent div is clicked.
