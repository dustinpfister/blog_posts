...
layout: post
id: 604
updated: 2020-02-03 15:15:40
version: 1.0
---

When I am starting out with a canvas project there is often a need to have some kind of system in place for creating a simple user interface that is just a bunch of buttons that preform all kinds of actions when clicked. You would think that this would be a simple task when it comes to canvas, but things are not like with html outside of the canvas element where one can just add an input element.
