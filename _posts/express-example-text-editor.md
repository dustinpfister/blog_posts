...
The error message will be sent as part of the standard reply object so if something goes wrong that infromation can be displayed in the client system.
