...
In this section I will be covering this in greater detail with some examples to help clarify this. Although I will be doing my best to keep these examples simple I assume that you have at least a little experience when it comes to the [first steps of learning javaScript](/2018/11/27/js-getting-started/). It might also be a good idea to read up more on [functions in javaScript in general](/2019/12/26/js-function/), as well as the subject of [closures](/2019/02/22/js-javascript-closure/) and the nature of the [this keyword](/2017/04/14/js-this-keyword/) as these things go hand in hand with variable scope in many ways.

### - These source code examples are on Github

As with all my [other posts on vanilla javaScript](/categories/js/) the source code examples in this post [can be found in my test vjs repository](https://github.com/dustinpfister/test_vjs/tree/master/for_post/js-javascript-scope).
