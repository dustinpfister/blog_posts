...
The main game module now has a few more helper methods that have to do with creating an updateing an upgrades object of the main game state object that this module is used to healp create and mutate.
