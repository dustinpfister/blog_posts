...
I can not say that I use object freeze that often, if fact so far I am not using it all all for that matter. I like to just try to treat certain objects as source objects, and [deep clone](/2017/11/13/lodash_clonedeep) new objects from those source objects. That way I do not need to bother with this method.
