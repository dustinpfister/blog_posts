...
I then also have a [wrapNumber method based off of what is used in the game frameWork known as phaser](/2018/07/22/phaser-math-wrap-and-clamp/), along with distance and bounding box collection detection methods. I also have a chunk method that works in more or less the same way as that of the [lodash chunk](/2017/09/13/lodash-chunk/) method as a basic tool for spiting an array into arrays of arrays. After that I have a whole bunch of methods that are based off of the source code from [angles.js](https://www.npmjs.com/package/angles) that work well for various tasks that have to do with angles.
