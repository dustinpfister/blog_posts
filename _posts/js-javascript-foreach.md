...
One additional feature that I might want to add to a general for each collection method is a mode that will cause the method to work in a kind of sparse array mode.
