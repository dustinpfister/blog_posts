...
So as you can see fs-extra makes each of the file system methods return a promise, if I comment one the fs option this will of course result in an error. If interested I have [written a post on fs-extra](/2018/01/08/nodejs-fs-extra/) a while back if you want to read more about that fs module drop in replacement.
