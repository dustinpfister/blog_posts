...
It is time to start breaking things down a little now, so for this example I made a stand alone module that I will be using to create a group of mesh objects.
