...
Just like any other threejs example I will also want a camera and a renderer, for this example I went with the perspective camera and the web gl renderer which are my usual suspects for just about everything that I do with threejs.
