...
## 1.2 - Setting actual full screen

It is possible to use the scale manager to set actual full screen more if the browser supports it. I have [written a post on actual full screen](/2017/10/15/phaser-scale-fullscreen/) a while back, but I do not think a solution that just depends on that alone will work out great. If you are going to bother with it, you might want to also do something similar to what I am doing in this post as well, as a kind of fall back.
