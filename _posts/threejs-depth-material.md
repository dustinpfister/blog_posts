...
There are a few options when it comes to cameras in three.js, but the typical camera that i use just about all the time would of course be the [perspective camera](/2018/04/07/threejs-camera-perspective/).
