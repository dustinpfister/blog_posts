---
title: 31 threejs examples that showcase many of the features of the library
date: 2021-02-19 14:42:00
tags: [three.js]
layout: post
categories: three.js
id: 807
updated: 2022-06-02 11:38:21
version: 1.58
---
...
### [ 2.15 - Vector3 apply Euler and lookAt](/2022/05/06/threejs-examples-lookat-with-apply-euler/) 
...
### [ 2.16 - Menus with threejs](/2021/12/03/threejs-examples-menus/)
...
### [ 2.17 - Nested groups](/2021/05/10/threejs-examples-nested-groups/)
...
### [ 2.18 - Object grid Wrap ](/2022/05/20/threejs-examples-object-grid-wrap/)
...
### [ 2.19 - Mutate a plane ](/2021/06/11/threejs-examples-plane-mutate/)
...
### [ 2.20 - Position things on the surface of a sphere](/2021/05/14/threejs-examples-position-things-to-sphere-surface/)
...
### [ 2.21 - Scene or object3d shake example](/2021/05/06/threejs-examples-scene-shake/)
...
### [ 2.22 - Video sequence hooks ](/2022/05/12/threejs-examples-sequence-hooks/)

When it comes to making videos I have found that I like to break down things into what I have come to call sequences.

### [ 2.23  - Mutate a sphere ](/2021/06/10/threejs-examples-sphere-mutate/)
...
### [ 2.24 - Source layer 3d](/2022/02/11/threejs-examples-tool-source-layer-3d/) 
...
### [ 2.25 - Tree sphere world](/2021/05/21/threejs-examples-tree-sphere-world/)
...
### [ 2.26 - Tree sphere](/2021/05/19/threejs-examples-tree-sphere/)
...
### [ 2.27 - Tree](/2019/07/30/threejs-examples-tree/)
...
### [ 2.28 - Waves](/2018/11/14/threejs-examples-waves/) 
...
### [ 2.29 - Weird walk guy 1](/2022/04/18/threejs-examples-weird-walk-one/) 
...
### [ 2.30 - Weird walk guy 2](/2022/04/25/threejs-examples-weird-walk-two/) 
...
### [ 2.31 - Weird walk guy 3](/2022/05/24/threejs-examples-weird-walk-three/) 
