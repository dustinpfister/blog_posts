---
title: 26 threejs examples that showcase many of the features of the library
...
### [ 2.10 - My First basic guy model](/2021/04/29/threejs-examples-guy-one/)
...
### [ 2.11 - Hamster Wheel](/2021/04/19/threejs-examples-hamster-wheel/) 
...
### [ 2.12 - House](/2021/04/23/threejs-examples-house/) 
...
### [ 2.13 - Land Sections](/2021/02/15/threejs-examples-land-sections/) 
...
### [ 2.14 - Menus with threejs](/2021/12/03/threejs-examples-menus/)
...
### [ 2.15 - Nested groups](/2021/05/10/threejs-examples-nested-groups/)
...
### [ 2.16 - Mutate a plane ](/2021/06/11/threejs-examples-plane-mutate/)
...
### [ 2.17 - Position things on the surface of a sphere](/2021/05/14/threejs-examples-position-things-to-sphere-surface/)
...
### [ 2.18 - Scene or object3d shake example](/2021/05/06/threejs-examples-scene-shake/)
...
### [ 2.19  - Mutate a sphere ](/2021/06/10/threejs-examples-sphere-mutate/)
...
### [ 2.20 - Source layer 3d](/2022/02/11/threejs-examples-tool-source-layer-3d/) 
...
### [ 2.21 - Tree sphere world](/2021/05/21/threejs-examples-tree-sphere-world/)
...
### [ 2.22 - Tree sphere](/2021/05/19/threejs-examples-tree-sphere/)
...
### [ 2.23 - Tree](/2019/07/30/threejs-examples-tree/)
...
### [ 2.24 - Waves](/2018/11/14/threejs-examples-waves/) 
...
### [ 2.25 - Weird walk guy 1](/2022/04/18/threejs-examples-weird-walk-one/) 
...
### [ 2.26 - Weird walk guy 2](/2022/04/25/threejs-examples-weird-walk-two/) 
