---
title: 41 threejs examples that showcase many of the features of the librray
...
### [ 2.7 - Camera Kit ](/2022/08/05/threejs-examples-camera-kit/)

This is a project that has to do with updaing the values of a camera over time.


### [ 2.8 - A Basic Clock Example](/2019/12/16/threejs-examples-clock-basic/)
...
### [ 2.9 - Cube Stack Example](/2022/04/29/threejs-examples-cube-stack/)
...
### [ 2.10 - Cube Stack Grid Example](/2022/05/02/threejs-examples-cube-stack-grid/)
...
### [ 2.11 - A dea file tools module ](/2021/06/25/threejs-examples-dae-tools/)
...
### [ 2.12 - DAE TOOLS and a Sphere with inverted normals ](/2022/05/31/threejs-examples-dae-tools-sphere-normals-invert/)
...
### [ 2.13 - My First basic guy model](/2021/04/29/threejs-examples-guy-one/)
...
### [ 2.16 - Land Sections](/2021/02/15/threejs-examples-land-sections/) 
...
### [ 2.17 - Lerp position attributes of buffer geometries](/2022/07/01/threejs-examples-lerp-geo/) 

Lerping the positions of one buffer geometry to another one.

### [ 2.18 - Lines Group Module ](/2022/06/10/threejs-examples-lines-deterministic/) 
...
### [ 2.21 - Many Object Tweening](/2022/08/26/threejs-examples-many-object-tweening/)
...
### [ 2.22 - Menus with threejs](/2021/12/03/threejs-examples-menus/)
...
### [ 2.23 - Nested groups](/2021/05/10/threejs-examples-nested-groups/)
...
### [ 2.24 - Object grid Wrap ](/2022/05/20/threejs-examples-object-grid-wrap/)
...
### [ 2.26 - Mutate a plane ](/2021/06/11/threejs-examples-plane-mutate/)
...
### [ 2.27 - Position things on the surface of a sphere](/2021/05/14/threejs-examples-position-things-to-sphere-surface/)
...
### [ 2.28 - Scene or object3d shake example](/2021/05/06/threejs-examples-scene-shake/)
...
### [ 2.29 - Video sequence hooks ](/2022/05/12/threejs-examples-sequence-hooks/)

When it comes to making videos I have found that I like to break down things into what I have come to call sequences.

### [ 2.30  - Mutate a sphere ](/2021/06/10/threejs-examples-sphere-mutate/)
...
### [ 2.33 - Tree sphere world](/2021/05/21/threejs-examples-tree-sphere-world/)
...
### [ 2.34 - Tree sphere](/2021/05/19/threejs-examples-tree-sphere/)
...
### [ 2.35 - Tree](/2019/07/30/threejs-examples-tree/)
...
### [ 2.36 - Waves](/2018/11/14/threejs-examples-waves/) 
...
### [ 2.37 - Weird face one](/2022/07/08/threejs-examples-weird-face-one/) 
...
### [ 2.38 - Weird walk guy 1](/2022/04/18/threejs-examples-weird-walk-one/) 
...
### [ 2.39 - Weird walk guy 2](/2022/04/25/threejs-examples-weird-walk-two/) 
...
### [ 2.40 - Weird walk guy 3](/2022/05/24/threejs-examples-weird-walk-three/) 

I wanted to make yet another one of these weird walk examples to which I might make a few more of.

### [ 2.41 - Wrap values module](/2022/09/09/threejs-examples-wrap-module/)
