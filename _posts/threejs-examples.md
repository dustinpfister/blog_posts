---
title: 42 threejs project example ideas from basic to not so basic
date: 2021-02-19 14:42:00
tags: [three.js]
layout: post
categories: three.js
id: 807
updated: 2022-09-30 14:25:15
version: 1.80
---
...
### [ 2.33 - Source layer 3d](/2022/02/11/threejs-examples-tool-source-layer-3d/) 
...
### [ 2.34 - Tree sphere world](/2021/05/21/threejs-examples-tree-sphere-world/)
...
### [ 2.35 - Tree sphere](/2021/05/19/threejs-examples-tree-sphere/)
...
### [ 2.37 - Waves](/2018/11/14/threejs-examples-waves/) 
...
### [ 2.38 - Weird face one](/2022/07/08/threejs-examples-weird-face-one/) 
...
### [ 2.39 - Weird walk guy 1](/2022/04/18/threejs-examples-weird-walk-one/) 
...
### [ 2.40 - Weird walk guy 2](/2022/04/25/threejs-examples-weird-walk-two/) 
...
### [ 2.41 - Weird walk guy 3](/2022/05/24/threejs-examples-weird-walk-three/) 

I wanted to make yet another one of these weird walk examples to which I might make a few more of.

### [ 2.42 - Wrap values module](/2022/09/09/threejs-examples-wrap-module/)
