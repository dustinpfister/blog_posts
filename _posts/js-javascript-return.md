...
In this section I will be started out with just a few simple examples of the javaScript return keyword when writing functions in javaScript. I will be doing my best to keep these examples as simple as possible for the sake of new developers, but I still assume that you have at least some experience when it comes to [getting started with javaScript](/2018/11/27/js-getting-started/) at least. It might also be a good idea to check out my [main post on javaScript functions in general](/2019/12/26/js-function/) when it comes to learning more about functions in javaScript and in general.

### - The source code examples here are on github

The source code examples for this post can be [found on Github here in my test vjs repository](https://github.com/dustinpfister/test_vjs/tree/master/for_post/js-javascript-return). I also have all the source code examples for all [my other posts on vanilla javaScript](/categories/js/) located there.
...
The default return value of a function is the [undefined value](/2019/01/30/js-javascript-undefined/). This can prove to be useful when it comes to making functions that will return a true or false value as the undefined value will also evaluate to false. However it is still a good idea to return false as a default anyway when making those kinds of functions.
