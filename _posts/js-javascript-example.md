...
categories: js
id: 837
updated: 2021-04-15 14:24:42
version: 1.46
---

Some may say that a good way to learn javaScript, or any programing language is to study the language itself, as well as various libraries that are written in the language. However learning javaScript is a lot like learning English, where learning the language itself is just a way to gain a kind of literacy.
...
### 1.9 - [Nodejs and Browser code share module pattern](/2021/04/14/js-javascript-example-nodejs-browser-share-code-module/)
...
### 1.12 - [Player unit grid](/2021/04/08/js-javascript-example-player-unit-grid/)
...
### 1.13 - [Ratio module](/2021/04/13/js-javascript-example-ratio-module)
...
### 1.14 - [Rotate and fire example](/2021/04/05/js-javascript-example/)
...
### 1.15 - [Skill Point System](/2020/08/26/js-javascript-example-skill-point-system/)
...
### 1.16 - [Sort planets](/2020/08/31/js-javascript-example-sort-planets/)
...
### 1.17 - [Tax brackets](/2020/02/27/js-javascript-example-tax-brackets/)
...
### 1.18 - [Test Module](/2021/04/12/js-javascript-example-test-module/)
...
### 1.19 - [Trade Sim](/2021/04/07/js-javascript-example-trade-sim/)
...
### 1.20 - [Zig Zag Arc](/2020/08/10/js-javascript-example-zig-zag-arc/)
