...
### 1.9 - [An exp point system](/2020/04/27/js-javascript-example-exp-system/)
...
### 1.10 - [Fizz buzz](/2020/06/26/js-javascript-example-fizzbuzz)
...
### 1.11 - [A game framework example](/2021/09/03/js-javascript-example-game-framework/)
...
### 1.12 - [Grid Game Unit Movement](/2020/08/11/js-javascript-example-grid-game-unit-movement/)
...
### 1.13 - [Grid Module](/2021/08/20/js-javascript-example-grid-module/)

In this post I am just going over the source code of a basic grid module.

### 1.14 - [idle game of a simple mine theme](/2021/07/16/js-javascript-example-idle-game-simple-mine/)
...
### 1.15 -  [wild plant grid idle game](/2021/08/13/js-javascript-example-idle-game-wild-plant-grid/)
...
### 1.16 - [Item probability](/2021/12/24/js-javascript-example-item-probability/)
...
### 1.17 - [A log once method](/2021/03/29/js-javascript-example-log-once/)
...
### 1.18 - [Simple map system for selecting a level in a game](/2021/04/06/js-javascript-example-map-system-simple/)
...
### 1.19 - [A basic multiplication table example](/2020/02/10/js-javascript-example-multiplication-table)
...
### 1.20 - [Nodejs and Browser code share module pattern](/2021/04/14/js-javascript-example-nodejs-browser-share-code-module/)
...
### 1.21 - [An Orb Module example about ratios](/2021/04/09/js-javascript-example-orb-module/)
...
### 1.22 - [A percent module experiment](/2020/11/25/js-javascript-example-percent-module/)
...
### 1.23 - [Player unit grid](/2021/04/08/js-javascript-example-player-unit-grid/)
