...
This is a post on using keyboard.createCursor keys to quickly create an object of hot keys for the arrow keys of a keyboard. This is not a post on the keyboard manager in general, or other aspects of handling input such as with pointer objects. This is not a getting started post on phaser ce, or javaScript in general as well.
