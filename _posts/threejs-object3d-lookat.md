...
In order to really start to get a feel for how the look at method works, and in the process find some of the short comings of this method, I will need to start working out a lot of animation examples of the method.
