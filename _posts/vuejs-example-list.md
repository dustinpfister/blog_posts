...
However there is just having a basic list example, and then there is staring to create an actual application that is a basic todo list application. So this will just be a pretty simple [vuejs example](/2021/02/04/vuejs-example/) of a todo list when it comes to getting this one out of the way.
