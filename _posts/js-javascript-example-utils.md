...
I then have a method that I can call from the source code of a project just once, and given it a canvas object, state, object, and an object of events for pointer methods.
...
In this section I have some quick demos of this utility module just for the sake of having some use case examples of the methods in the module.
