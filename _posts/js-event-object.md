...
So in this basic getting started type section I will be going over just a few simple getting started type examples of event attachment, and working with event objects in the event handlers that will be used. Although I will be keeping these examples very simple, this is still not a [getting started with javaScript](/2018/11/27/js-getting-started/) from an absolute beginner. Even in this basic section i assume that you have at least a little experience when it comes to the first steps of client side javaScript as well as nodejs.
