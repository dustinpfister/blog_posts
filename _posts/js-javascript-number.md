...
In this example I am using the [array filter method](/2020/10/03/js-array-filter/) to filter out all elements except elements that are of the type called number.
